    ...
    <div id="position_nav">
        ...
        <div id="position_opt">
            <ul>
                ...
                <li>
	                <s:form name="deleteForm" action="/sysmge/memberuser/deleteInfo.action">
	                    <s:hidden name="ID" value="%{#request.user.ID}"/>
                ...
                <li>
                    <s:form name="modifyForm" action="/sysmge/memberuser/modify.action">
					    <s:hidden name="ID" value="%{#request.user.ID}"/>
                ...
                <li>
                    <s:form name="modifyPasswordForm" action="/sysmge/memberuser/modifyPassword.action">
					    <s:hidden name="ID" value="%{#request.user.ID}"/>
