...
<html>
<head>
<title>会员用户信息列表</title>
<%
    //TODO 修改为从request中直接获取（struts2可能存在多次转发，目前request中只能获得jsp页面的请求URL，以后修改）
    String thisPageUrl = request.getContextPath() + "/sysmge/memberuser/list.action";;//此列表页面的请求URL
...
<div id="main"> 
    ...
    <div id="position_nav">
        ...
        <!-- div id="position_opt">
            <ul>
                <li>
                <s:form name="createForm" action="/sysmge/memberuser/create.action">
                    <a href="#" onClick="createUser()"> 
                        <img src="${contextPath}/images/bt_add.gif" alt="新增" name="addImage" height="23" border="0" align="absbottom" onmouseover="changeImg(this,'${contextPath}/images/bt_add_over.gif')" onmouseout="changeImg(this,'${contextPath}/images/bt_add.gif')">
                    </a>
                </s:form>
                </li>
            </ul>
    ...
    <!-- 表單信息 -->
    <s:form name="userListForm" action="/sysmge/memberuser/search.action"> 
    ...
    <div id="cnt_sch2">          
        <ul>
            ...
            <li>中文名：<s:textfield name="chsName" cssClass="search_text"/></li>
            <li>
    ...
    <div id="cnt_lt">
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="form-table">
            ...
            <tr <s:if test="true == #st.odd">class='list-tr2'</s:if><s:else>class='list-tr1'</s:else> onmouseover='listSelect(this)' onmouseout='listUnSelect(this)' >
                <td class='align-l'>
                    <s:property value="userTypeName" escape="false"/>
                </td>
                <td class='align-l'>
