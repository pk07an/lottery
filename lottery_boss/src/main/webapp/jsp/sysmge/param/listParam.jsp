...
<%
    ...
    String thisPageUrl = request.getContextPath() + "/sysmge/param/list.action";//此列表页面的请求URL
...
<script>
    //调用详细信息页面的js
    function modify(){     
        document.paramForm.action="${contextPath}/sysmge/param/modifyParam.action";
        document.paramForm.submit;
    }
    function del(){    
        document.paramForm.action="${contextPath}/sysmge/param/delParam.action";
        document.paramForm.submit;
    }
    function add(){
        document.paramForm.action="${contextPath}/sysmge/param/addParam.action";
        document.paramForm.submit();
    }
    function searchparam(){
        document.paramForm.action="${contextPath}/sysmge/param/searchParam.action";
        document.paramForm.submit();
    }   
</script>
</head>
...
<div id="main"> 
    ...
    <!-- 表單信息 -->
    <s:form name="paramForm" action="/sysmge/param/list.action"> 
    
    <!-- 查詢信息栏 start -->
    <div id="cnt_search2">
    <div id="cnt_sch2">          
        <ul>
            <li>参数代碼：<s:textfield name="code" cssClass="search_text"/></li>
            <li>参数名稱：<s:textfield name="name" cssClass="search_text"/></li>
            <li>参数狀態：<s:select list="#request.stateMap" name="state" ></s:select></li>
            <li>
                創建时间：<sx:datetimepicker name="createTimeStart" displayFormat="yyyy-MM-dd"/>
                —<sx:datetimepicker name="createTimeEnd" displayFormat="yyyy-MM-dd"/>
            </li>
            <li>
                <a href="#" onClick="searchparam()">
    ...
    <div id="cnt_lt">
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="form-table">
            ...
            <tr align='center'>
                <td width='34%' class='tab-bag' align="center" nowrap>
                     参数代碼
                 </td>
            ...
            <tr <s:if test="true == #st.odd">class='list-tr2'</s:if><s:else>class='list-tr1'</s:else> onmouseover='listSelect(this)' onmouseout='listUnSelect(this)' >
                ...
                <td class='align-c' nowrap>
                    <s:url action="viewParam.action" id="viewUrl">
                        <s:param name="ID" value="ID" />
                        <s:param name="_pagecount" value="1" />
                    </s:url>
                    <s:a href="%{viewUrl}">
                        <img
            ...
            <td colspan="11" class="tab-head">
                ...
                <tr>
                    ...
                    <td align="right" valign="bottom" nowrap>
                        ...
                        <a href="#" onclick="return checkPageGo('paramForm','${thisPageUrl}?action=list')"><img src="${contextPath}/images/page-go.gif" alt="跳转到指定页" border="0" align="absmiddle"/></a><input type="text" name="pageGoNumInput" value="" maxlength="4" size="3" class="goInput" onfocus='this.select()'>&nbsp;
