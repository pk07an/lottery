...
<html>
<head>
<title>基础用户信息列表</title>
<%
    //TODO 修改为从request中直接获取（struts2可能存在多次转发，目前request中只能获得jsp页面的请求URL，以后修改）
    String thisPageUrl = request.getContextPath() + "/sysmge/manageruser/list.action";;//此列表页面的请求URL
...
<div id="main"> 
    ...
    <div id="position_nav">
        ...
        <div id="position_opt">
            <ul>
                <li>
                <s:form name="createForm" action="/sysmge/manageruser/create.action">
    ...
    <!-- 表單信息 -->
    <s:form name="userListForm" action="/sysmge/manageruser/search.action"> 
