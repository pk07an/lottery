...
<div id="main">
    ...
    <div id="cnt_lt">
        ...
        <s:form name="createForm" action="/sysmge/manageruser/createSubmit.action">
            ...
            <tr>
                ...
                <td width="32%">
                    <s:select list="#request.userTypeList" name="userType" listKey="key" listValue="name"></s:select>
                </td>
                <td width="18%" class="cnt_td">
      				登录帳號：
                </td>
