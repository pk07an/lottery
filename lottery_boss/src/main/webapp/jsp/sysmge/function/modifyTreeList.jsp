...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<script language="JavaScript">
	 ...
	 <%  
		long selectId = 1;
		if(null != request.getAttribute("viewTreeID")){
			selectId = (Long)request.getAttribute("viewTreeID");
		}
		...
		for (int i = 0; i < list.size(); i++){
			...
			str.append(";");
			str.append("url:");
			str.append("modifyDetail.action?ID=" + entity.getID());//点击节点后对应的 URL
			str.append("\'");
