...
<%
    ...
    String thisPageUrl = request.getContextPath() + "/sysmge/user/selectMultiUserList.action";//此列表页面的请求URL
    ...
    <div id="cnt_lt">
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="form-table">
            ...
            <tr <s:if test="true == #st.odd">class='list-tr2'</s:if><s:else>class='list-tr1'</s:else> onmouseover='listSelect(this)' onmouseout='listUnSelect(this)' >
                <td class='align-c'>
                    <input type="checkbox" name="userID" value="<s:property value='ID'/><%=Constant.SELECT_USERID_USERNAME_SPLIT %><s:property value='chsName'/>" style="border: 0"/>
                </td>
