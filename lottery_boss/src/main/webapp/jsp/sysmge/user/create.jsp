...
<script>
    ...
    function checkData(){
        var orgID = document.createForm.orgID.value;
        ...
        if(null == orgID || 0 == orgID.length){
            alert("请选择所属机构！");
            document.createForm.orgID.focus();
            return false;
        }
...
<div id="main">
    ...
    <div id="cnt_lt">
        ...
        <s:form name="createForm" action="/sysmge/user/createSubmit.action">
            ...
            <tr>
                ...
                <td width="32%">
                    <s:textfield name="orgName" size="22" title="选择机构" readonly="true"></s:textfield>
