...
<script>
    ...
    function authorizView(){
        ...
        var url = "${contextPath}/sysmge/authoriz/authorizUserViewMain.action?userID=" + userID;
        //打开模式窗口
    ...
    function authorizPrivate(){
        var userID = document.userInfoForm.ID.value;
        var url = "${contextPath}/sysmge/authoriz/authorizUserPrivate.action?userID=" + userID;
        //打开模式窗口
    ...
    function authorizRole(){
        var userID = document.userInfoForm.ID.value;
        var url = "${contextPath}/sysmge/authoriz/authorizUserRoleMain.action?userID=" + userID;
        //打开模式窗口
        var ret = openModalDialog('${contextPath}/common/ModalDialogPage.jsp',url,600,500);
    }
    ...
    <div id="position_nav">
        ...
        <div id="position_opt">
            <ul>
                ...
                <li>
	                <s:form name="deleteForm" action="/sysmge/user/deleteInfo.action">
	                    <s:hidden name="ID" value="%{#request.user.ID}"/>
                ...
                <li>
                    <s:form name="modifyForm" action="/sysmge/user/modify.action">
					    <s:hidden name="ID" value="%{#request.user.ID}"/>
                ...
                <li>
                    <s:form name="modifyPasswordForm" action="/sysmge/user/modifyPassword.action">
					    <s:hidden name="ID" value="%{#request.user.ID}"/>
