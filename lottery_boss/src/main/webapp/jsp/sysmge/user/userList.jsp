...
<%
    ...
    String thisPageUrl = request.getContextPath() + "/sysmge/user/list.action";;//此列表页面的请求URL
...
<div id="main"> 
    ...
    <div id="position_nav">
        ...
        <div id="position_opt">
            <ul>
                <li>
                <s:form name="createForm" action="/sysmge/user/create.action">
    ...
    <!-- 表單信息 -->
    <s:form name="userListForm" action="/sysmge/user/search.action"> 
    ...
    <div id="cnt_lt">
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="form-table">
            ...
            <tr align='center'>
                <td width='24%' class='tab-bag' nowrap>
                    登陆帳號
                </td>
                <td width='27%' class='tab-bag' nowrap>
                    中文名
                </td>
