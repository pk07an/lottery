    ...
    <script language="JavaScript">
     ...
     <%  
        ...
        for (int i = 0; i < list.size(); i++){
            ...
            if(entity.isLeaf() && entity.isAuthoriz()){
                //叶子节点，并且通过角色授权的数据
                //str.append("<font color=\"#000000\">");
                //str.append(entity.getFuncName()+"</font>;");//树上显示的名稱
                str.append(entity.getFuncName()+";");//树上显示的名稱
            }else if(entity.isLeaf() && entity.isPrivateAuthoriz()){
                //叶子节点，并且通过私有授权的数据
                str.append("<font color=\"" + Constant.COLOR_GREEN +"\">");
                str.append(entity.getFuncName()+"</font>;");//树上显示的名稱
            }else{
                str.append(entity.getFuncName()+";");//树上显示的名稱
            }
