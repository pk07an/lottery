...
window.open("${pageContext.request.contextPath}/member/queryMemberWarmomgStatent.action?type=message",'_self'); 
<%}else{%>
window.open("${pageContext.request.contextPath}/memberLogin.jsp",'_self'); 
<%}%>
</Script>
</head> 
</html>
