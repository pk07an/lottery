...
public class BjscOddsAction extends BaseAdminLotteryAction {
	...
	public String ajaxSetOdds() {
		...
		// 未開盤不能修改
    	if(null == this.getBJRunningPeriodsNum() ||"".equals(getBJRunningPeriodsNum()))
    	{
...
//        BigDecimal autoMoney=openOdd.getAutoOdds();//自动降赔率
        ...
        log.setType("2");
		try{
			log.setPeriodsNum(this.getBJRunningPeriodsNum());
