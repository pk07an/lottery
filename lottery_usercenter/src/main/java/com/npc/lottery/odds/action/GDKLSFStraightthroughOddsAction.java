...
public class GDKLSFStraightthroughOddsAction extends BaseAdminLotteryAction {
	 ...
	 */
	private String subType = Constant.LOTTERY_GDKLSF_SUBTYPE_STRAIGHTTHROUGH;
	...
	public String updateOdds() {
		...
		while (names.hasMoreElements()) {
			...
			if (ele.indexOf("GDKLSF_STRAIGHTTHROUGH_") != -1) {
