...
var checkCodeResult = false;//验证码校验结果
    ...
    function checkForm(){
        ...
        var userPassword = document.LoginForm.userPwdInput.value;
    ...
    //改变验证码
    function changeCode(){
        document.getElementById("codeImage").src="${pageContext.request.contextPath}/checkCodeManager.jsp?"+Math.random()*1000;
    }
    ...
    function checkCode(){
        var code = document.LoginForm.code.value;
        if (code != ""){    
            var strUrl = '${pageContext.request.contextPath}/user/ajaxCheckCode.action?code=' + code;
    ...
    function submitForm(){
    	if(checkForm())	{
    		var webAppUrl = "/user/loginManager.action";
    		var serverNameOrg = "<%=request.getServerName()%>";
			...
			var serverNameArray = serverNameOrg.split(".");
			serverNameNew = userName + "."
							+ serverNameArray[serverNameArray.length - 4] + "." 
		...
		serverNameNew = scheme + "://" + serverNameNew + webAppUrl;

		$("#LoginForm").attr("action", serverNameNew);
			      ...
			      <tr>
			        <td height="354" align="center" valign="top"><table width="320" border="0" cellspacing="0" cellpadding="0">
			          ...
			          <tr>
			            ...
			            <td align="left"><input type="password" class="ip"  value="" name="userPwdInput" tabindex="2" id="userPwdInput"/></td>
			          ...
			          <tr>
			            ...
			            <td align="left"><input type="text" name="code" tabindex="3" maxlength="4" class="ip_code" style="float: left"/>
			              <img src="${pageContext.request.contextPath}/checkCodeManager.jsp" width="88" height="32" style="vertical-align:middle;position:relative;margin-left:4px;border-radius:2px 2px 2px 2px;float: left;" id="codeImage" onClick="changeCode();"/>
			            </td>
			          </tr>
			          <tr>
