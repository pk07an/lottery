		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="king mt4">
				<tbody>
					...
					<tr onmouseover="changeColorToYL_chief(this)" onmouseout="changeColorToOld_chief(this)" onclick="changeColor(this)">
						...
						<td class="t_right getClass5"><a href="javascript:function blankinfo(){return false;}" id='<s:property value="subordinate" escape="false"/>' 
						...
						<td nowrap class="t_right">
							<s:property value="rateMoney" /><!-- 实占金额 -->
						</td>
						<td nowrap class="t_right">
		            ...
		            <s:if test="null != #request.totalEntity">
		                ...
		                <tr bgcolor='#F1F1F1'>
							...
							<td nowrap class="t_right"><s:property value="rateMoney" /></td><!-- 实占注额 -->
