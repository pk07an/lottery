			...
			<!--控制表格头部结束-->
			 <tr>
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="king mt4">
				<tbody>
					<tr>
					    <th width="7%" nowrap><b><s:property value="#request.userTypeName"/></b></th>
                        <th width="9%" nowrap>名稱</th>
                        <th width="7%" nowrap>筆</th>
                        <th width="9%" nowrap><b>有效金額</b></th>
                        <th width="9%" nowrap>會员輸贏</th>
                        <th width="9%" nowrap>应收下線</th>
                        <th width="6%" nowrap>占成%</th>
                        <th width="10%" nowrap>實占注額</th>
                        <th width="7%" nowrap>占貨比%</th>
                        <th width="9%" nowrap>實占輸贏</th>
                        <th width="9%" nowrap>實占退水</th>
                        <th width="9%" nowrap>實占結果</th>
					</tr>
					...
					<!-- 行间隔色显示和当前行反白显示，固定写法 -->
					<tr onmouseover="changeColorToYL_chief(this)" onmouseout="changeColorToOld_chief(this)" onclick="changeColor(this)">
						<td nowrap>
						...
						<td nowrap class="t_right getClass5">
							<a href="javascript:function blankinfo(){return false;}" id='<s:property value="userID" escape="false"/>' 
                                 ...
                                 onmouseout="hideDesc('<s:property value="userID" escape="false"/>')"><s:property value="subordinateAmountDis"/></a>
						</td>
		...
		<tr>
		    <td height="35" background="${pageContext.request.contextPath}/images/admin/tab_19.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
		        ...
		        <td align="center">
			        <strong>
			           	占成結果：<span class="red"><s:property value="#request.totalEntity.realResultNewDis" escape="false"/></span>/&nbsp;&nbsp;抵扣補貨及賺水后結果：<span class="blue"><s:property value="#request.dkDis" escape="false"/></span>
			        </strong>
		        </td>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="king mt4">
                <tbody>
                    ...
                    <tr onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''" onclick="changeColor(this)">
                        ...
                        <td nowrap class="t_right">
                       	    <s:url action="settledRelenishDetailedEric.action" id="replenishViewUrl">
                                <s:param name="userID" value="userID"/>
							 	<s:param name="lotteryType" value="lotteryType"/>
								<s:param name="playType" value="playType"/>
								<s:param name="bettingDateStart" value="bettingDateStart"/>
