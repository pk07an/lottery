...
<script type="text/javascript">
    ...
    function openDetailedReportPop(infoLink){
        ...
        //打开模式窗口，固定写法，不要改变
//          openModalDialogReport(url,'',1006,1000);
			 ...
			 <tr>
			    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
					...
					<!-- 表格内容开始 一行六列-->
					<!-- 表格内容结束 一行六列-->
		      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="king mt4" id="report">
				<tbody>
					<tr>
					    <th width="5%" nowrap><s:property value="#request.userTypeName"/></th>
                        <th width="5%" nowrap>名稱</th>
                        <th width="4%" nowrap>筆</th>
                        <th width="8%" nowrap><b>有效金額</b></th>
                        <th width="8%" nowrap>會员輸贏</th>
                        <th width="8%" nowrap>应收下線</th><!-- 标5 -->
                        <th width="4%" nowrap>占成%</th>
                        <th width="8%" nowrap>實占注額</th>
                        <th width="4%" nowrap>占貨比%</th>
                        <th width="8%" nowrap>實占輸贏</th>
                        <th width="5%" nowrap>實占退水</th>
                        <th width="8%" nowrap>實占結果</th>
                        <th width="5%" nowrap>賺取退水</th> 
                        <th width="8%" nowrap>賺水后結果</th> 
                        <th width="6%" nowrap>貢獻上級</th> <!-- 标14 -->
                        <th width="6%" nowrap>應付上級</th> <!-- 标15 -->
					</tr>
					...
					<tr onmouseover="changeColorToYL(this)" onmouseout="changeColorToOld(this)" onclick="changeColor(this)">
						<td nowrap><s:if test="userType == 6">
								<!-- 代理明细 -->
					            <s:url action="settledListEric.action" id="viewUrl">
						...
						<td nowrap class="t_right"><s:if test="userType == 9">
								<!-- 查询普通会员、直属会员投注明细 -->
								<s:url action="settledDetailedListEric.action" id="viewUrl">
								 	<s:param name="lotteryType" value="lotteryType"/>
								 	<s:param name="playType" value="playType"/>
								 	<s:param name="userID" value="userID"/>
								 	<s:param name="bettingDateStart" value="bettingDateStart"/>
								 	...
								 	<s:param name="periodsNum" value="periodsNum"/>
								 	<s:param name="selectTypeRadio" value="selectTypeRadio"/>
								 	<s:param name="parentUserType" value="parentUserType"/>
								</s:url>  
						...
						<td nowrap class="t_right getClass5"><a href="javascript:function blankinfo(){return false;}" id='<s:property value="userID" escape="false"/>' 
                                 onmouseover="showDesc('<s:property value="userID" escape="false"/>||<s:property value="subordinate" escape="false"/>||<s:property value="subordinateAmountWinDis" escape="false"/>||<s:property value="subordinateAmountBackWaterDis" escape="false"/>')" 
                                 onmouseout="hideDesc('<s:property value="userID" escape="false"/>')"><s:property value="subordinateAmountDis"/></a></td>
		            ...
		            <s:if test="null != #request.totalEntity">
		                ...
		                <tr bgcolor='#F1F1F1'>
		                    <td align="right" colspan="2"><div align="right">合計：</div></td>
							<td nowrap><s:property value="turnover" escape="false"/></td>
							...
							<td nowrap class="t_right"><a href="javascript:function blankinfo(){return false;}" id='totalYinShou' 
	                                 onmouseover="showDesc('totalYinShou||<s:property value="#request.userTypeName" escape="false"/>||<s:property value="subordinateAmountWinDis" escape="false"/>||<s:property value="subordinateAmountBackWaterDis" escape="false"/>')" 
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="king mt4">
                <tbody>
                    ...
                    <tr onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''" onclick="changeColor(this)">
                        ...
                        <td nowrap class="t_right"><s:url action="settledRelenishDetailedEric.action" id="replenishViewUrl">
                                <s:param name="userID" value="userID"/>
							 	<s:param name="lotteryType" value="lotteryType"/>
								<s:param name="playType" value="playType"/>
								<s:param name="bettingDateStart" value="bettingDateStart"/>
