          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="99%" align="left" class="F_bold">&nbsp;總代理    直屬會員 -&gt; 新增</td>
              </tr>
            </table>
            </td>
 ...
 <table width="100%" border="0px" cellspacing="0" cellpadding="0" class="mt4 king higher">
  <tr>
    ...
    <td class="t_left"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="none_border">
      <tr>
        <td width="" colspan="2"><s:radio name="userType" id="jq_userType" list="#request.userTypeMap" label="直屬上級" value="5" onclick="changeUserType()">
						</s:radio> </td>
