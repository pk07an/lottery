...
self.location="${pageContext.request.contextPath}/user/queryBranchStaff.action?type=userBranch&searchUserStatus=${searchUserStatus}&pageNo=${page.pageNo}&searchType=${searchType}&searchValue=${searchValue}";
} 
</script>

<div class="content">
	<s:form name="sForm" action="%{pageContext.request.contextPath}/user/queryBranchStaff.action?type=userBranch">
			      ...
			      <tr>
			        ...
			        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			          <tr>
			            ...
			            <td width="124" align="left" class="F_bold">分公司管理</td>
			            ...
			            <td class="t_right"width="129"><img src="${pageContext.request.contextPath}/images/admin/newadd.gif" width="14" height="13" /> <a href="${pageContext.request.contextPath}/user/saveBranchStaff.action?searchType=${searchType}&searchValue=${searchValue}&searchUserStatus=${searchUserStatus}">新增分公司</a></td>
			            </tr></table></td>
...
<col width="3%" />
				...
				<!-- 		<th>狀態</th>
					...
					<% int count = 1; %>
					<s:iterator value="#request.page.result" status="branch" var="bch">
						<tr onmouseover="this.style.backgroundColor='#FFFFA2'"
							...
							<td><s:property value="chiefRate" escape="false" />%</td>
							<td class="TD_R"><s:property value="account" escape="false" /></td>
							...
							<s:action name="userTree" executeResult="true"  flush="false">
							   ...
							   <s:param name="userType">3</s:param>
							</s:action>
							
							<%-- <td><s:property value="#bch.stockholderStaffExtSet.size()" escape="false" /></td>
							<td><s:property value="#bch.stockholderStaffExtSet.size()" escape="false" /></td>
							<td><s:property value="#bch.stockholderStaffExtSet.size()" escape="false" /></td>
							<td><s:property value="#bch.stockholderStaffExtSet.size()" escape="false" /></td> --%>
						...
						<img  src="${pageContext.request.contextPath}/images/admin/tuishui.gif"/>
						 <a class="btn_4" href="${pageContext.request.contextPath}/user/queryBranchcommission.action?qUserID=<s:property value="encodeId" escape="false"/>&searchType=${searchType}&searchValue=${searchValue}&searchUserStatus=${searchUserStatus}" target="_self">退水</a>
						 <img  src="${pageContext.request.contextPath}/images/admin/xiugai.gif"/>
							    <a class="btn_4" href="${pageContext.request.contextPath}/user/updateFindByBranchStaff.action?account=<s:property value="account" escape="false"/>&searchType=${searchType}&searchValue=${searchValue}&searchUserStatus=${searchUserStatus}">修改</a>
							   <img  src="${pageContext.request.contextPath}/images/admin/rizhi.gif"/>
								<a class="btn_4" href="${pageContext.request.contextPath}/admin/queryLoginLog.action?qUserID=<s:property value="encodeId" escape="false"/>">日志</a>
							...
							<td>
<s:if test="openReport==0"> <img  src="${pageContext.request.contextPath}/images/admin/buhuo.gif"/></s:if> 
<s:elseif test="openReport==1"><img  src="${pageContext.request.contextPath}/images/admin/zongzhang.gif"/></s:elseif>
							...
							<td>
							<s:if test="leftOwner==0"> <img  src="${pageContext.request.contextPath}/images/admin/zhan.gif"/></s:if> 
<s:elseif test="leftOwner==1"><img  src="${pageContext.request.contextPath}/images/admin/zhan2.gif"/></s:elseif>
							
							</td>
							<td>
							<s:if test="flag==0"> <a href="##" name="userStatus" data="<s:property value="account" escape="false" />|0|3"><input type="button" value="啟用"/> </a></s:if> 
				     	    <s:if test="flag==1">
							<strong ><a href="##" name="userStatus" data="<s:property value="account" escape="false" />|1|3"><input type="button" value="停用" class="red"/></a></strong>
							</s:if> 
							<s:if test="flag==2">
									<strong ><a href="##" name="userStatus" data="<s:property value="account" escape="false" />|2|3"> <input type="button" value="凍結" class="blue"/></a></strong>
							</s:if>
				...
				<tbody>
					<tr>
						<td><s:if test="#request.page.totalCount>0">
								<lottery:paginate
									url="${pageContext.request.contextPath}/user/queryBranchStaff.action"
									param="" />
							</s:if></td>
					</tr>
				</tbody>
		  ...
		  <tr>
		    ...
		    <table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
		        ...
		        <lottery:paginate
									url="${pageContext.request.contextPath}/user/queryBranchStaff.action"
									param="searchUserStatus=${searchUserStatus}"  recordType="個分公司帳號"/>
		       <%--  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<colgroup>
		          <col width="40%" />
				  <col width="20%" />
