...
$(document).ready(function() {
 ...
 $("#tuishui").change(function(){   
	 ...
	 $("#moneyTotalCredit").val(<%=moneyCredit%>);//信用額度剩多少
});
	...
	<s:form id="sForm" action="%{pageContext.request.contextPath}/user/savaImmediateMember.action" method="post">
		<div class="main">
			<table cellspacing="0" cellpadding="0" border="0" width="100%"
				...
				<tbody>
					<tr>
						<th colspan="2">分公司直属会员注冊</th>
					</tr>
						<tr>
						<td class="tr">直属上级帳號</td>
						<td class="tl"><input type="text"
							value="${branchStaffExt.account}" name="memberStaffExt.managerStaff.account" readonly="readonly"></input></td>
						</tr>
					<tr>
					...
					<tr>
						...
						<tr>
						<td class="tr">信用額度</td>
						<td class="tl"><input  onblur="javascript:checkNum();" id="totalCredit"  onafterpaste="this.value=this.value.replace(/\D/g,'')" onkeyup="this.value=this.value.replace(/\D/g,'')" value="" name="memberStaffExt.totalCreditLine"
							class="w176" type="text" maxlength="9"/></input><span  style="color: #FF0000;">可开信用額度还剩<input type="text" id="moneyTotalCredit" value="0" readonly="readonly" style="border:none"></span></td>
						</tr>
					<tr>
						<td class="tr">盘口</td>
						<td class="tl">
