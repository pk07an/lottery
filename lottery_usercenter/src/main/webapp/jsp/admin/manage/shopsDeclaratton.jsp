		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			                   ...
			                   <%-- <%
						    	...
						    	%>  --%>
			                     <img src="${pageContext.request.contextPath}/images/admin/newadd.gif" width="14" height="13" /> 
										<a class="btn_4" href="${pageContext.request.contextPath}/user/saveFindMessage.action?type==message">新增站內消息</a>
			                    <%-- <%
									}
								%> --%>
			            </td>
										...
										<tbody>
											...
											<s:iterator value="#request.page.result" status="branch">
												<tr onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
													...
													<td><div style="width:600px;margin:0 auto;text-align:left;"><AD_Info><s:property value="contentInfo" escape="false" /></AD_Info></div></td>
													...
													<td>
														<a class="btn_4" href="${pageContext.request.contextPath}/user/updateFindMessage.action?shopID=<s:property value="ID" escape="false" />"><img  src="${pageContext.request.contextPath}/images/admin/xiugai.gif"/>修改</a> &nbsp;&nbsp;
														<a class="btn_4" href="${pageContext.request.contextPath}/user/deleteMessage.action?shopID=<s:property value="ID" escape="false" />"><img  src="${pageContext.request.contextPath}/images/admin/delete.gif"/>删除</a>
													</td>
												</tr>
											</s:iterator>
										</tbody>
		    ...
		    <td height="35" background="${pageContext.request.contextPath}/images/admin/tab_19.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
		        ...
		        <td align="center">
		          <lottery:paginate url="${pageContext.request.contextPath}/user/queryAllMessage.action" param="" recordType=" 條公告"/>
		        </td>
