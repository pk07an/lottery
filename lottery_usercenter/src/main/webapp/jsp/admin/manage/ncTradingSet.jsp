...
<body>
<div class="content">
  <s:form action="updateNCTradingSet.action" namespace="admin">
				...
				<tr>
					<td height="30"
						background="${pageContext.request.contextPath}/images/admin/tab_05.gif"><div
							id="Tab_top">
							<table border="0" cellpadding="0" cellspacing="0" class="ssNC_l"
								id="Tab_top_left">
								<tr>
							...
							<table id="Tab_top_right" class="ssNC_r" border="0"
  ...
  <tr>
	...
	<td><table width="100%" border="0" cellspacing="0"
      ...
      <s:iterator value="showList" status="st">
	        ...
	        <s:if test="playFinalType.trim()=='NC_ONE_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_TWO_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_THREE_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_FOUR_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_FIVE_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_SIX_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_SEVEN_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_EIGHT_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_OEDX_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_OEDS_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_OEWSDX_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_HSDS_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_FW_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_ZF_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_ZHDX_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_ZHDS_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_ZHWSDX_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_LH_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_RXH_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_RELZ_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_RTLZ_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_RXS_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_XSQZ_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_XTQZ_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_RXF_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='NC_RXW_BALL'"><td>${playFinalTypeName}</td></s:if>
		    ...
		    <td>
		        <s:if test="playFinalType.trim()=='NC_RXH_BALL' || playFinalType.trim()=='NC_RELZ_BALL' || playFinalType.trim()=='NC_RTLZ_BALL'
		              || playFinalType.trim()=='NC_RXS_BALL' || playFinalType.trim()=='NC_XSQZ_BALL' || playFinalType.trim()=='NC_XTQZ_BALL'
		               || playFinalType.trim()=='NC_RXF_BALL' || playFinalType.trim()=='NC_RXW_BALL'">
                     <strong>...</strong>
