...
<body>
<div class="content">
  <s:form action="updateCqTradingSet.action" namespace="admin">
  ...
  <tr>
	...
	<td><table width="100%" border="0" cellspacing="0"
      ...
      <s:iterator value="showList" status="st">
	        ...
	        <s:if test="playFinalType.trim()=='CQ_ONE_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='CQ_TWO_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='CQ_THREE_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='CQ_FOUR_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='CQ_FIVE_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='CQ_OFDX_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='CQ_OFDS_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='CQ_ZHDX_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='CQ_ZHDS_BALL'"><td>${playFinalTypeName}</td></s:if>		   
		    <s:if test="playFinalType.trim()=='CQ_LH_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='CQ_QS_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='CQ_ZS_BALL'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='CQ_HS_BALL'"><td>${playFinalTypeName}</td></s:if>
