...
<body>
<div class="content">
  <s:form action="updateK3TradingSet.action" namespace="admin">
  ...
  <tr>
	...
	<td><table width="100%" border="0" cellspacing="0"
      ...
      <s:iterator value="showList" status="st">
	        ...
	        <s:if test="playFinalType.trim()=='K3_DX'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='K3_SJ'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='K3_WS'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='K3_QS'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='K3_DS'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='K3_CP'"><td>${playFinalTypeName}</td></s:if>
		    <s:if test="playFinalType.trim()=='K3_DP'"><td>${playFinalTypeName}</td></s:if>
