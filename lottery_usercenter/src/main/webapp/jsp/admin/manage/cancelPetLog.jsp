...
<div class="content">
	<s:form id="sform" method="post" action="queryCancelPetLog.action" name="sform" namespace="admin">
			      ...
			      <tr>
			        ...
			        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			          <tr>
			            ...
			            <td width="124" align="left" class="F_bold">注單操作日誌</td>
				...
				<tbody>
					...
					<s:iterator value="#request.list" status="st">
						<tr onMouseOver="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
							<td><s:property value="createDateDis" /></td>
