...
<div class="content">
    <s:form id="sForm" action="/user/updateChiefMessage.action" method="post">
	<div class="main">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align='center'>
						    ...
						    <input name="" type="reset" class="btn2" value="重置" />
						    <input name="shopsDeclaratton.ID" type="hidden" value='<s:property value="shopsDeclaratton.ID"/>' />
						</td>
