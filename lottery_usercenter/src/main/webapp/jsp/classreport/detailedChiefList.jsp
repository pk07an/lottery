		...
		<div class="main">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tbody>
					...
					<tr>
						<th width="17%" nowrap>注單號碼/時間</th>
						<th width="16%" nowrap>下注類型</th>
						<th width="7%" nowrap>会员</th>
						<th width="18%" nowrap>下注明細</th>
						<th width="6%" nowrap>會員下注</th>
						<th width="6%" nowrap>會員輸贏</th>
						<th width="5%" nowrap>代理</th>
						<th width="5%" nowrap>总代理</th>
						<th width="5%" nowrap>股东</th>
						<th width="5%" nowrap>分公司</th>
						<th width="5%" nowrap>总监</th>
						<th width="5%" nowrap><font color='#FF0000'>您的結果</font></th>
					</tr>
					...
					<tr <s:if test="true == #st.odd">class=''</s:if><s:else>class='even'</s:else> onmouseover='listSelect(this)' onmouseout='listUnSelect(this)' >
                        ...
                        <td align="center" nowrap>
                            <s:property value="rateBranchName" />
                            <br/>
                            <!-- 分公司下级的退水 -->
                            <s:property value="commissionStockholderValue2" />
                        </td>
                        <td align="center" nowrap>
                            <s:property value="rateChiefName" />
                            <br/>
                            <!-- 总监下级的退水 -->
                            <s:property value="commissionBranchValue2" />
                        </td>
						<td align="center">
                            <s:property value="resultChief" />
                            <br/>
                            <s:property value="backWaterResultChief" />
                        </td>
					</tr>
					</s:iterator>
