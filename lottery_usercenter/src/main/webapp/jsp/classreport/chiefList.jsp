...
<script type="text/javascript">
    ...
    function openDetailedReportPop(infoLink){
        ...
        //打开模式窗口，固定写法，不要改变
//         var ret = openModalDialogReport(url,'',1006,950);
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="king mt4">
				<tbody>
					<tr>
                        ...
                        <th width="6%" nowrap>占貨比%</th>
                        <th width="6%" nowrap>實占輸贏</th>
                        <th width="6%" nowrap>實占退水</th>
                        <th width="6%" nowrap><b>實占結果</th>
					</tr>
		            ...
		            <s:if test="null != #request.totalEntity">
		                ...
		                <tr bgcolor='#F1F1F1'>
							...
							<td  nowrap class="even5"><a href="javascript:function blankinfo(){return false;}" id="totalYinShou"
