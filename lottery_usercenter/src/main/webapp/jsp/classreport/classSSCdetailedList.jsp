      ...
      <tr>
        ...
        <td align="center">
            <s:if test="#request.isPet=='true'">
	            <lottery:paginate url="${pageContext.request.contextPath}/classreport/classDetailedListEric.action" 
	            param="playType=${playType}&bettingDateStart=${bettingDateStart}&bettingDateEnd=${bettingDateEnd}&selectTypeRadio=${selectTypeRadio}
	            &periodsNum=${periodsNum}" recordType=" 筆注單"/>
            </s:if><s:else>
	            <lottery:paginate url="${pageContext.request.contextPath}/classreport/classRelenishDetailedEric.action" 
		            param="playType=${playType}&bettingDateStart=${bettingDateStart}&bettingDateEnd=${bettingDateEnd}&selectTypeRadio=${selectTypeRadio}
		            &periodsNum=${periodsNum}" recordType=" 筆注單"/>
            </s:else>
          </td>
