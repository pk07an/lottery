	...
	<s:form name="sForm" action="#">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="king mt4">
				<tbody>
					...
					<!-- 行间隔色显示和当前行反白显示，固定写法 -->
					<tr onmouseover="changeColorToYLClass_chief(this)" onmouseout="changeColorToOldClass_chief(this)" onclick="changeColor(this)">
						<td nowrap>
		            ...
		            <s:if test="null != #request.totalEntity">
		                ...
		                <tr bgcolor='#F1F1F1'>
							...
							<td class="even5" nowrap><a href="javascript:function blankinfo(){return false;}" id="totalYinShou"
		    ...
		    <td height="35" background="${pageContext.request.contextPath}/images/admin/tab_19.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
		        ...
		        <td align="center"><strong>
			        	   占成結果：<span class="red">0.0</span>&nbsp;&nbsp;/&nbsp;&nbsp;抵扣補貨后結果：<span class="blue">0.0</span>
			        </strong></td>
...
<!--控制底部操作按钮结束-->
		...
		<!--中间内容结束-->
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tbody>
					<tr>
						<th width="15%"><b>筆</b></th>
						<th width="17%"><b>補貨金額</b></th>
						<th width="17%"><b>補貨輸赢</b></th>
