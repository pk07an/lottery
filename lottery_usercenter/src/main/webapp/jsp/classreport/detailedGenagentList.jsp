		...
		<div class="main">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tbody>
					...
					<tr>
						<th width="20%" nowrap>注單號碼/時間</th>
						<th width="20%" nowrap>下注類型</th>
						<th width="7%" nowrap>会员</th>
						<th width="20%" nowrap>下注明細</th>
					...
					<tr <s:if test="true == #st.odd">class=''</s:if><s:else>class='even'</s:else> onmouseover='listSelect(this)' onmouseout='listUnSelect(this)' >
						...
						<td align="center">
                            <s:property value="resultGenAgent" />
                            <br/>
                            <s:property value="backWaterResultGenAgent" />
                        </td>
					</tr>
					</s:iterator>
