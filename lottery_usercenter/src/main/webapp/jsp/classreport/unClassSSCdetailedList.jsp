      ...
      <tr>
        ...
        <td align="center">
            <s:if test="#request.isPet=='true'">
	            <lottery:paginate url="${pageContext.request.contextPath}/classreport/unClassDetailedList.action" 
	            ...
	            <lottery:paginate url="${pageContext.request.contextPath}/classreport/unClassRelenishDetailed.action" 
		            param="playType=${playType}&bettingDateStart=${bettingDateStart}&bettingDateEnd=${bettingDateEnd}&selectTypeRadio=${selectTypeRadio}
		            &periodsNum=${periodsNum}" recordType=" 筆注單"/>
            </s:else>
          </td>
