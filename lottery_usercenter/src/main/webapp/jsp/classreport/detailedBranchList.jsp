			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tbody>
					...
					<tr>
						...
						<th width="6%" nowrap>代理</th>
						<th width="6%" nowrap>总代理</th>
						<th width="6%" nowrap>股东</th>
						<th width="6%" nowrap>分公司</th>
						<th width="6%" nowrap><font color='#FF0000'>您的結果</font></th>
					</tr>
					...
					<tr <s:if test="true == #st.odd">class=''</s:if><s:else>class='even'</s:else> onmouseover='listSelect(this)' onmouseout='listUnSelect(this)' >
						...
						<td align="center">
                            <s:property value="resultBranch" />
                            <br/>
                            <s:property value="backWaterResultBranch" />
                        </td>
					</tr>
					</s:iterator>
