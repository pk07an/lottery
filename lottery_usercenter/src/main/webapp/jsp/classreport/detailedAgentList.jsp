			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tbody>
					...
					<tr>
						...
						<th width="8%" nowrap>会员</th>
						<th width="21%" nowrap>下注明細</th>
						<th width="7%" nowrap>會員下注</th>
						<th width="7%" nowrap>會員輸贏</th>
						<th width="7%" nowrap>代理</th>
						<th width="8%" nowrap><font color='#FF0000'>您的結果</font></th>
					</tr>
					...
					<tr <s:if test="true == #st.odd">class=''</s:if><s:else>class='even'</s:else> onmouseover='listSelect(this)' onmouseout='listUnSelect(this)' >
						...
						<td align="center">
							<s:property value="resultAgent" />
							<br/>
							<s:property value="backWaterResultAgent" />
						</td>
					</tr>
					</s:iterator>
