		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="king mt4">
				<tbody>
					...
					<tr onmouseover="changeColorToYLClass(this)" onmouseout="changeColorToOldClass(this)" onclick="changeColor(this)">
						<td nowrap>
							<s:property value="commissionTypeName" />
						</td>
						<td nowrap>
							<s:property value="turnover" escape="false"/>
						</td>
						<td nowrap class="t_right">
							<s:url action="unClassDetailedList.action" id="viewUrl">
							...
							<s:a href="%{viewUrl}" cssClass="noneA_UnderLine blue" onclick="return openDetailedReportPop(this)" title="查看会员投注明细">
					  			<s:property value="amountDis"/><!-- 總下注額 -->
							</s:a>
						</td>
						<td nowrap class="t_right">0.0</td>
						<td class="t_right getClass5" nowrap><a href="javascript:function blankinfo(){return false;}" id="<s:property value="commissionType" escape="false"/>"
                                 onmouseover="showDesc('<s:property value="commissionType" escape="false"/>','<s:property value="commissionTypeShortName" escape="false"/>')" 
                                 onmouseout="hideDesc('<s:property value="commissionType" escape="false"/>')">0.0</a></td>
						<td  nowrap class="t_right">
						...
						<td nowrap class="t_right">0.0</td>
						<td nowrap class="t_right">0.0</td>
						<td nowrap class="t_right"><b>0.0</b></td>
		            ...
		            <s:if test="null != #request.totalEntity">
		                ...
		                <tr bgcolor='#F1F1F1'>
							...
							<td nowrap class="t_right">0.0</td>
							<td  nowrap class="t_right" bgcolor='#F1F1F1'><a href="javascript:function blankinfo(){return false;}" id="totalYinShou"
                                 onmouseover="showDesc('totalYinShou','總')" 
							...
							<td nowrap class="t_right">100.00</td><!-- 占货比 -->
							<td nowrap class="t_right">0.0</td>
							<td nowrap class="t_right">0.0</td>
							<td nowrap class="t_right">0.0</td>
							<td nowrap class="t_right">0.0</td>
...
<!--控制底部操作按钮结束-->
		...
		<!--中间内容结束-->
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tbody>
					<tr>
						<th width="15%"><b>補貨類型</b></th>
						<th width="5%"><b>筆</b></th>
						<th width="17%"><b>補貨金額</b></th>
						<th width="12%"><b>補貨輸赢</b></th>
						<th width="17%"><b>退水</b></th>
						<th width="17%"><b>退水后結果</b></th>
					</tr>
					<!-- 迭代显示 List 集合中存储的数据记录 -->
                    ...
                    <tr onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''" onclick="changeColor(this)">
                        ...
                        <td  nowrap class="t_right">
                       	    <s:url action="unClassRelenishDetailed.action" id="replenishViewUrl">
                                <s:param name="playType" value="commissionType"/>
								<s:param name="bettingDateStart" value="bettingDateStart"/>
								<s:param name="bettingDateEnd" value="bettingDateEnd"/>
								<s:param name="periodsNum" value="periodsNum"/>
                    ...
                    <s:iterator value ="#request.replenishTotalEntity">
		                <tr bgcolor='#F1F1F1'>
		                    <td align="right">
								<div align="right"><b>合計：</b></div>
							</td>
							<td nowrap>
								<b><s:property value="turnover" escape="false"/></b><!-- 笔 -->
							</td>
							<td  nowrap class="t_right">
                                <s:property value="amountDis"/> 
	                        </td>
