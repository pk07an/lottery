...
function changeOdds(typeCode,jiajian)
{
	...
	var strUrl = '${pageContext.request.contextPath}/admin/ajaxCQBalloddsUpdate.action';
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" id="oddTable">
      <tr>
        ...
        <s:iterator value="#request.ballMap1">
            <jsp:include page="/jsp/replenish/cqMiddleForChief.jsp" />
        </s:iterator>     
	   <tr class="sub_th">
          <td colspan="4">第四球</td>
        </tr>
...
/* $(document).ready(function(){
	var double = context+'/replenish/ajaxtwoSideAndDragonRank.do?from=CQSSC';
	$.ajax({url:double,dataType:"html",type:"POST",success:function(data){ $("#doubleStat").html(data);parent.topFrame.cqdoubleRightStat=data;}});
}); */
</script>
