...
com.npc.lottery.odds.action.OddMapProxy,com.npc.lottery.periods.entity.NCPeriodsInfo,
...
$(document).ready(function() {	
    ...
    $(".rOp").on("click", function () {
    	...
    	if ($("#searchType").val()=="1"){
		    ...
		    $div.show();
	   	    $("#rOdds").focus();
	   	    getTypeCodeState("NCZHLH",typeCode,"");
    	}  
    	<%}%>
    });  
	...
	<td width="16" align="right"><img src="${pageContext.request.contextPath}/images/admin/tab_07.gif" width="16" height="30" /></td>
		...
		<table id="Tab_top_left" border="0" cellspacing="0" cellpadding="0">
		    <tr>
			    ...
			    <td width="16"><img src="${pageContext.request.contextPath}/images/admin/tb.gif" width="16" height="16" /></td>
