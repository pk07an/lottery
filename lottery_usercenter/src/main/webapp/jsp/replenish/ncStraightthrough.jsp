    ...
    function rOp(vo){
    	if($("#searchType").val()!=2){
	    	...
	    	if ($("#searchType").val()=="1"){
			    ...
			    $div.show();
		        $("#moneyOther").focus();
	   	     	getTypeCodeState("NCLM",item,$("#attributeOther").val());
	    	}  
    	}
    }
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <colgroup>
		  ...
		  <tr>
		    <td <s:if test='#request.RunningPeriods.state=="2" && #request.rMap.NC_STRAIGHTTHROUGH_RX2.fpState=="0" '> class="even"</s:if><s:else>class="even3"</s:else>>任选二</td>
		    <td class="even3">选二连直</td>
		    <td <s:if test='#request.RunningPeriods.state=="2" && #request.rMap.NC_STRAIGHTTHROUGH_R2LZ.fpState=="0"'> class="even"</s:if><s:else>class="even3"</s:else>>选二连组</td>
		    <td <s:if test='#request.RunningPeriods.state=="2" && #request.rMap.NC_STRAIGHTTHROUGH_RX3.fpState=="0"'> class="even"</s:if><s:else>class="even3"</s:else>>任选三</td>
		    <td class="even3">选三前直</td>
		    <td <s:if test='#request.RunningPeriods.state=="2" && #request.rMap.NC_STRAIGHTTHROUGH_R3LZ.fpState=="0"'> class="even"</s:if><s:else>class="even3"</s:else>>选三前组</td>
		    <td <s:if test='#request.RunningPeriods.state=="2" && #request.rMap.NC_STRAIGHTTHROUGH_RX4.fpState=="0"'> class="even"</s:if><s:else>class="even3"</s:else>>任选四</td>
		    <td <s:if test='#request.RunningPeriods.state=="2" && #request.rMap.NC_STRAIGHTTHROUGH_RX5.fpState=="0"'> class="even"</s:if><s:else>class="even3"</s:else>>任选五</td>
		    </tr>
            <tr>
              <!-- 賠率内容 -->
