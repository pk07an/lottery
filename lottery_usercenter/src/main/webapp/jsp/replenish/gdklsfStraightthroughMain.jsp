...
<%@ page import="java.util.*,com.npc.lottery.replenish.vo.ReplenishVO,com.npc.lottery.odds.action.OddMapProxy,com.npc.lottery.common.Constant,com.npc.lottery.periods.entity.GDPeriodsInfo" %>
...
<script language="javascript" src="${pageContext.request.contextPath}/js/replenish_LM.js"></script>
...
function showContentMain() {
	...
	$.ajax({
		...
		data : {"subType":$("#subType").val(),"searchArray":"lose",
			"loseSort":"lose","searchType":"0","plate":"A"},
		dataType : "html",
...
<!--内容开始-->
<div class="content" id="content"><input type="hidden" id="subType" value="<s:property value="#request.subType"/>"/></div>
<!--内容结束-->

<jsp:include page="/jsp/replenish/replenishPopLM.jsp" />
</body>
</html>
