...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="king zonge">
        ...
        <tr>
          ...
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_BALL_FIRST %>"><%=map.get("BALL_FIRST").getRightBarMoney() %></a></span></b> </td>
        ...
        <tr>
          ...
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_BALL_SECOND %>"><%=map.get("BALL_SECOND").getRightBarMoney() %></a></span></b> </td>
        ...
        <tr>
          ...
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_BALL_THIRD %>"><%=map.get("BALL_THIRD").getRightBarMoney() %></a></span></b> </td>
        ...
        <tr>
          ...
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_BALL_FORTH %>"><%=map.get("BALL_FORTH").getRightBarMoney() %></a></span></b> </td>
        ...
        <tr>
          ...
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_BALL_FIFTH %>"><%=map.get("BALL_FIFTH").getRightBarMoney() %></a></span></b> </td>
        ...
        <tr>
          ...
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_BALL_SIXTH %>"><%=map.get("BALL_SIXTH").getRightBarMoney() %></a></span></b> </td>
        ...
        <tr>
          ...
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_BALL_SEVENTH %>"><%=map.get("BALL_SEVENTH").getRightBarMoney() %></a></span></b> </td>
        ...
        <tr>
          ...
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_BALL_EIGHTH %>"><%=map.get("BALL_EIGHTH").getRightBarMoney() %></a></span></b> </td>
          <td><strong class="blue_s">08</strong></td>
          <td><%=map.get("8").getYLsum() %></td>
        </tr>
        <tr>
          <td class="lightgreen">總和大小： <b><span class="green">
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_DRAGON %>"><%=map.get("NC_ZHDX_BALL").getRightBarMoney() %></a></span></b> </td>
          <td><strong class="blue_s">09</strong></td>
          <td><%=map.get("9").getYLsum() %></td>
        </tr>
        <tr>
          <td class="lightgreen">總和單雙： <b><span class="green">
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_DRAGON %>"><%=map.get("NC_ZHDS_BALL").getRightBarMoney() %></a></span></b> </td>
          <td><strong class="blue_s">10</strong></td>
          <td><%=map.get("10").getYLsum() %></td>
        </tr>
        <tr>
          <td class="lightgreen">總尾大小： <b><span class="green">
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_DRAGON %>"><%=map.get("NC_ZHWSDX_BALL").getRightBarMoney() %></a></span></b> </td>
          <td><strong class="blue_s">11</strong></td>
          <td><%=map.get("11").getYLsum() %></td>
        </tr>
        <tr>
          <td class="lightgreen">龍&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;虎： <b><span class="green">
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_DRAGON %>"><%=map.get("NC_LH_BALL").getRightBarMoney() %></a></span></b> </td>
          <td><strong class="blue_s">12</strong></td>
          <td><%=map.get("12").getYLsum() %></td>
        </tr>
        <tr>
          <td class="lightgreen">任&nbsp;選&nbsp;&nbsp;二： <b><span class="green">
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_STRAIGHTTHROUGH %>"><%=map.get("NC_STRAIGHTTHROUGH_RX2").getRightBarMoney() %></a></span></b> </td>
          <td><strong class="blue_s">13</strong></td>
          <td><%=map.get("13").getYLsum() %></td>
        </tr>
        <tr>
          <td class="lightgreen">選二連直： <b><span class="green">
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_STRAIGHTTHROUGH %>"><%=map.get("NC_STRAIGHTTHROUGH_R2LZHI").getRightBarMoney() %></a></span></b> </td>
          <td><strong class="blue_s">14</strong></td>
          <td><%=map.get("14").getYLsum() %></td>
        </tr>
        <tr>
          <td class="lightgreen">選二連組： <b><span class="green">
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_STRAIGHTTHROUGH %>"><%=map.get("NC_STRAIGHTTHROUGH_R2LZ").getRightBarMoney() %></a></span></b> </td>
          <td><strong class="blue_s">15</strong></td>
          <td><%=map.get("15").getYLsum() %></td>
        </tr>
        <tr>
          <td class="lightgreen">任&nbsp;選&nbsp;&nbsp;三： <b><span class="green">
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_STRAIGHTTHROUGH %>"><%=map.get("NC_STRAIGHTTHROUGH_RX3").getRightBarMoney() %></a></span></b> </td>
          <td><strong class="blue_s">16</strong></td>
          <td><%=map.get("16").getYLsum() %></td>
        </tr>
        <tr>
          <td class="lightgreen">選三前直： <b><span class="green">
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_STRAIGHTTHROUGH %>"><%=map.get("NC_STRAIGHTTHROUGH_R3LZHI").getRightBarMoney() %></a></span></b> </td>
          <td><strong class="blue_s">17</strong></td>
          <td><%=map.get("17").getYLsum() %></td>
        </tr>
        <tr>
          <td class="lightgreen">選三前組： <b><span class="green">
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_STRAIGHTTHROUGH %>"><%=map.get("NC_STRAIGHTTHROUGH_R3LZ").getRightBarMoney() %></a></span></b> </td>
          <td><strong class="blue_s">18</strong></td>
          <td><%=map.get("18").getYLsum() %></td>
        </tr>
        <tr>
          <td class="lightgreen">任&nbsp;選&nbsp;&nbsp;四： <b><span class="green">
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_STRAIGHTTHROUGH %>"><%=map.get("NC_STRAIGHTTHROUGH_RX4").getRightBarMoney() %></a></span></b> </td>
          <td><strong class="blue_s">19</strong></td>
          <td><%=map.get("19").getYLsum() %></td>
        </tr>
        <tr>
          <td class="lightgreen">任&nbsp;選&nbsp;&nbsp;五： <b><span class="green">
          <a target="mainFrame" href="${pageContext.request.contextPath}/replenish/replenishSet.action?subType=<%=Constant.LOTTERY_NC_SUBTYPE_STRAIGHTTHROUGH %>"><%=map.get("NC_STRAIGHTTHROUGH_RX5").getRightBarMoney() %></a></span></b> </td>
