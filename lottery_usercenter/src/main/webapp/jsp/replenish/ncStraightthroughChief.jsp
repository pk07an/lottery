...
<%@ page import="java.util.*,com.npc.lottery.odds.action.OddMapProxy,com.npc.lottery.odds.entity.ShopsPlayOdds,com.npc.lottery.periods.entity.NCPeriodsInfo" %>
<%@ taglib prefix="s" uri="/struts-tags"%>
<%

NCPeriodsInfo cqp=(NCPeriodsInfo)request.getAttribute("RunningPeriods");
  ...
  //设置元素的坐标
    ...
    $('#oddTable a').click(function() {
       ...
       <%}else{%>
		  ...
		  if(typeCode!="NC_STRAIGHTTHROUGH_R2LZHI" && typeCode!="NC_STRAIGHTTHROUGH_R3LZHI"){
...
function changeOdds(typeCode,jiajian)
{
	...
	var strUrl = '${pageContext.request.contextPath}/admin/ajaxNCBalloddsUpdate.action';
...
function getChnName(type){
	var chnName ="";
	if(type=="NC_STRAIGHTTHROUGH_RX2"){
		chnName="任選二";
    }else if(type=="NC_STRAIGHTTHROUGH_RX3"){
	    chnName="任選三";
	}else if(type=="NC_STRAIGHTTHROUGH_RX4"){
		chnName="任選四";
	}else if(type=="NC_STRAIGHTTHROUGH_RX5"){
		chnName="任選五";
	}else if(type=="NC_STRAIGHTTHROUGH_R3LZ"){
		chnName="选三连组";
	}else if(type=="NC_STRAIGHTTHROUGH_R2LZ"){
		chnName="选二连组";
	}
	return chnName;
}
...
function submitPageAjax_LM(typeCode) {
	var strUrl = 'ajaxReplenishNCLmMain.do';
...
<s:form action="replenishSet.action" namespace="replenish" id="rForm" method="post">
 ...
 <input type="hidden" id="lotteryType" value="NC"/>
 <input type="hidden" id="times" />
  ...
  <td align="left">
	...
	<td width="16" align="right"><img src="${pageContext.request.contextPath}/images/admin/tab_07.gif" width="16" height="30" /></td>
		...
		<table id="Tab_top_center" class="NC_r" border="0" cellspacing="0" cellpadding="0" style="width:360px;margin:0 auto;">		
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <colgroup>
		  ...
		  <tr>
		    <td <s:if test='#request.RunningPeriods.state=="2" && #request.rMap.NC_STRAIGHTTHROUGH_RX2.fpState=="0" '> class="even"</s:if><s:else>class="even3"</s:else>>
		    <a id="NC_STRAIGHTTHROUGH_RX2" href="javascript:void(0)" name="notPlay">任选二</a></td>
		    <td class="even3">选二连直</td>
		    <td <s:if test='#request.RunningPeriods.state=="2" && #request.rMap.NC_STRAIGHTTHROUGH_R2LZ.fpState=="0"'> class="even"</s:if><s:else>class="even3"</s:else>>
		    <a id="NC_STRAIGHTTHROUGH_R2LZ" href="javascript:void(0)" name="notPlay">选二连组</a></td>
		    <td <s:if test='#request.RunningPeriods.state=="2" && #request.rMap.NC_STRAIGHTTHROUGH_RX3.fpState=="0"'> class="even"</s:if><s:else>class="even3"</s:else>>
		    <a id="NC_STRAIGHTTHROUGH_RX3" href="javascript:void(0)" name="notPlay">任选三</a></td>
		    <td class="even3">选三前直</td>
		    <td <s:if test='#request.RunningPeriods.state=="2" && #request.rMap.NC_STRAIGHTTHROUGH_R3LZ.fpState=="0"'> class="even"</s:if><s:else>class="even3"</s:else>>
		    <a id="NC_STRAIGHTTHROUGH_R3LZ" href="javascript:void(0)" name="notPlay">选三前组</a></td>
		    <td <s:if test='#request.RunningPeriods.state=="2" && #request.rMap.NC_STRAIGHTTHROUGH_RX4.fpState=="0"'> class="even"</s:if><s:else>class="even3"</s:else>>
		    <a id="NC_STRAIGHTTHROUGH_RX4" href="javascript:void(0)" name="notPlay">任选四</a></td>
		    <td <s:if test='#request.RunningPeriods.state=="2" && #request.rMap.NC_STRAIGHTTHROUGH_RX5.fpState=="0"'> class="even"</s:if><s:else>class="even3"</s:else>>
		    <a id="NC_STRAIGHTTHROUGH_RX5" href="javascript:void(0)" name="notPlay">任选五</a></td>
		    </tr>
            <tr>
              <!-- 賠率内容 -->
