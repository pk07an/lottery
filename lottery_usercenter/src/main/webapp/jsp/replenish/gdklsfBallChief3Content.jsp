...
<%
Map<String,ReplenishVO> oddMap=(Map<String,ReplenishVO>)request.getAttribute("GDShopOddsMap");
...
$(document).ready(function(){
	var double = context+'/replenish/ajaxtwoSideAndDragonRank.do?from=GDKLSF';
