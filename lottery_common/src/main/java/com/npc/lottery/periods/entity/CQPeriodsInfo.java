...
public class CQPeriodsInfo implements Serializable{

    /**
     * 
     */
    private static final long serialVersionUID = -812928552966712759L;

    private java.lang.Long ID;

    // fields
    private java.lang.String periodsNum;   // 投注期数，形如 20120203001，具有唯一性，编号规则为年月日+玩法当日期数序号
