...
public interface IGDPeriodsInfoDao extends ILotteryBaseDao<Long, GDPeriodsInfo>{
	/**
	 * 每天广东快乐十分业务结束从投注表里（关联盘期表,获得盘期对象,只获取盘期是4或者7已经开奖或兑奖的数据）获取遗漏兑奖的盘期列表，用作每日结束的重新兑奖
	 * @return
	 */
	public abstract List<GDPeriodsInfo> getPeriodsInfoFromBetTableForReLotteryEOD(String scheme);
