 ...
 *
 */
public class ParamDao extends HibernateDaoSupport implements IParamDao {
	...
	public List findParamList(final ConditionData conditionData,
		...
		return getHibernateTemplate().executeFind(new HibernateCallback() {
			public Object doInHibernate(Session session)
				...
				Criteria criteria = session.createCriteria(Param.class);
	...
	public Param getParamByID(Long id) {
		return (Param) getHibernateTemplate().get(Param.class, id);
	}
