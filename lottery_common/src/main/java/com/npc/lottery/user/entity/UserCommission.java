...
public class UserCommission implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = -8275683704967315246L;
    private Long ID; //
    ...
    private Double displayCommissionA; // 佣金A
    private Double displayCommissionB; // 佣金b
    private Double displayCommissionC; // 佣金c
    ...
    private Set<PlayType> playTypes=new HashSet(); 
	...
	public double getDisplayCommissionA() {
		// return BigDecimal.valueOf(100 - this.commissionA).setScale(3,BigDecimal.ROUND_HALF_UP);
		return 100 - this.commissionA;
	}

	public double getDisplayCommissionB() {
		// return BigDecimal.valueOf(100 - this.commissionB).setScale(3,BigDecimal.ROUND_HALF_UP);
		return 100 - this.commissionB;
	}

	public double getDisplayCommissionC() {
		// return BigDecimal.valueOf(100 - this.commissionC).setScale(3,BigDecimal.ROUND_HALF_UP);
		return 100 - this.commissionC;
	}
	...
	public Set<PlayType> getPlayTypes() {
		return playTypes;
	}

	public void setPlayTypes(Set<PlayType> playTypes) {
