 ...
 * 
 */
public class DeliveryUnReport implements Serializable, Cloneable {
     ...
     * 克隆对象
     */
    public DeliveryUnReport clone() throws CloneNotSupportedException {
        return (DeliveryUnReport) super.clone();
    }
