...
public class NCRule {
	...
	public static int straightthrough(String attr, String playTypeCode,
		...
		if ("NC_STRAIGHTTHROUGH_R2LZ".equals(playTypeCode)) {
		...
		} else if ("NC_STRAIGHTTHROUGH_R3LZ".equals(playTypeCode)) {
		...
		} else if ("NC_STRAIGHTTHROUGH_RX2".equals(playTypeCode)) {
		...
		} else if ("NC_STRAIGHTTHROUGH_RX3".equals(playTypeCode)) {
		...
		} else if ("NC_STRAIGHTTHROUGH_RX4".equals(playTypeCode)) {
		...
		} else if ("NC_STRAIGHTTHROUGH_RX5".equals(playTypeCode)) {
	...
	public static void main(String[] args) {
		String playType = "NC_STRAIGHTTHROUGH_RX2";
		String attr = "4|16";
	...
	public static int getNCLMMaxWinCount(int comSize)
    {
