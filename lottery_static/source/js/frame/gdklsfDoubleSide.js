...
$(document).ready(function() {
	 ...
	 $("#betSubmit").click(function() {
			...
			var parameter="";
			//alert($("#betTable td[name='inputPrice'] :input[type='text']").size());
			var sum=0;
	 ...
	 var options = { 
		        beforeSubmit:  validate, 
		        success:       showResponse,  		 
		        url:       context+'/member/ajaxklsfDoubleSideSub.do',       
		        type:      'post',         
		        dataType:  'json'       	     
		    }; 
...
var subType=$("#subType",frameDocument('mainFrame')).val();
form.html("");
form.attr('action',"ajaxklsfDoubleSideSub.do");
