...
<div class="main">
  ...
  <div class="top_content"><select class="mr10" name="" onChange="forwardToLotteryHistory(this.options[this.options.selectedIndex].value)">
      <option value="GDKLSF" selected >廣東快樂十分</option>
 ...
 <%
  ...
  <s:if test="#request.page.totalCount>0">
    <div style="width:88%">  
	<lottery:paginate url="${pageContext.request.contextPath}/${path}/enterLotResultHistory.xhtml" param="subType=GDKLSF" recordType=" 期記錄"/>
	</div>
</s:if>
