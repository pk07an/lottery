...
<%
	...
	String shopState = (String)request.getAttribute("shopState");
	String path = (String)request.getAttribute(Constant.COOKIE_PATH);
...
alert("<%=info%>");
<%if(userState!=null && "userFreeze".equals(userState) && !"".equals(path) && null != path){%>
window.location.href="${pageContext.request.contextPath}"+path+"queryMemberWarmomgStatent.xhtml"; 
<%}else{%>
window.location.href="${pageContext.request.contextPath}/memberLogin.xhtml?shopcode=${shopCode}";
<%}%>
</Script>
</head> 
</html>
